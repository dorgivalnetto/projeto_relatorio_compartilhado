...
// DECRYPT O ID
$id_vinculo = base64_decode($_GET['q']);

// INSTANCIANDO
$selectVinculosPeloId = selectVinculosServidoresPeloId($id_vinculo);
$vinculo = mysqli_fetch_object($selectVinculosPeloId);
?>
                ...
                <div class="col-md-12">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Alterar Vínculo</h6>
                        </div>
                        <div class="card-body">
                            <form role="form" action="controller/vinculos/updateConfiguracoesVinculo.php" method="post" enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="codigo_vinculo" name="codigo_vinculo" 
                                            placeholder="Digite o código do vínculo" value="<?= $vinculo->codigo_vinculo ?>" required>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <label for="nome_vinculo">Nome do Vínculo</label>
                                        <input type="text" class="form-control" id="nome_vinculo" name="nome_vinculo" 
                                            placeholder="Digite o nome do vínculo" value="<?= $vinculo->nome_vinculo ?>" required>
                                    </div>
                                </div>
